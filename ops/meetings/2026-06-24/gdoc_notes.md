...
> Pulled from Google Doc **Pixel Agent Weekly - Meeting Notes (Abdoul + Raghav + Amaad + Matt)** on 2026-06-25.
...
[https://github.com/MaximusAnax/pixel_agent](https://github.com/MaximusAnax/pixel_agent) 
...
Stable Diffusion 3 paper: [https://arxiv.org/pdf/2403.03206](https://arxiv.org/pdf/2403.03206) 
...
Judge: Qwen3.5-VL 9B
Existing code
OpenCUA [https://github.com/xlang-ai/OpenCUA](https://github.com/xlang-ai/OpenCUA) 
...
OSWORLD-G [https://arxiv.org/pdf/2505.13227](https://arxiv.org/pdf/2505.13227)	
...
GUI-Perturbed [https://arxiv.org/pdf/2604.14262](https://arxiv.org/pdf/2604.14262) 
...
Abdoul: [andiongu@andrew.cmu.edu](mailto:andiongu@andrew.cmu.edu) for both
Raghav: [raghavgupta@cmu.edu](mailto:raghavgupta@cmu.edu) 
...
From Qwen3-VL paper [https://arxiv.org/pdf/2511.21631](https://arxiv.org/pdf/2511.21631)
...
Qwen3 0.6B ​​[https://huggingface.co/Qwen/Qwen3-0.6B-Base](https://huggingface.co/Qwen/Qwen3-0.6B-Base)	
Qwen3 1.7B [https://huggingface.co/Qwen/Qwen3-1.7B-Base](https://huggingface.co/Qwen/Qwen3-1.7B-Base)		

Background
[https://timdettmers.com/2026/01/27/building-open-coding-agent-sera/](https://timdettmers.com/2026/01/27/building-open-coding-agent-sera/)	
Moat is pursuing smaller-scale models
Security/privacy incentive for smaller models
Practicalities 
Timeline: 
Compute: Babel (just andrew ids) + PSC Bridges (create accounts here  and send me usernames [https://allocations.access-ci.org/](https://allocations.access-ci.org/))  + Slurm (to read up on)
...
[https://unsloth.ai/docs/models/gemma-4/train](https://unsloth.ai/docs/models/gemma-4/train)
